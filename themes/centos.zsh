# =============================================================================
# DistroZSH - themes/centos.zsh
# =============================================================================
# CentOS Stream theme: CentOS Blue (#2A6BB2).
# =============================================================================

typeset -g DISTROZSH_THEME_NAME="centos"
typeset -g DISTROZSH_THEME_USER_COLOR="white"
typeset -g DISTROZSH_THEME_ROOT_COLOR="red"
typeset -g DISTROZSH_THEME_SEPARATOR_COLOR="#2A6BB2"
typeset -g DISTROZSH_THEME_DISTRO_COLOR="#2A6BB2"
